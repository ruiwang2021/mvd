...
OUTPUT_DIR='OUTPUT/mvd_vit_small_with_vit_large_teacher_k400_epoch_400/finetune_on_k400'
MODEL_PATH='OUTPUT/mvd_vit_small_with_vit_large_teacher_k400_epoch_400/checkpoint-399.pth'
DATA_PATH='k400_anno'
