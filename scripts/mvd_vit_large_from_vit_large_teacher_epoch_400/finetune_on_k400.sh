...
OUTPUT_DIR='OUTPUT/mvd_vit_large_with_vit_large_teacher_k400_epoch_400/finetune_on_k400'
MODEL_PATH='OUTPUT/mvd_vit_large_with_vit_large_teacher_k400_epoch_400/checkpoint-399.pth'
DATA_PATH='k400_anno'
...
OMP_NUM_THREADS=1 python -m torch.distributed.launch --nproc_per_node=${GPUS} \
    ...
    --batch_size 2 --update_freq 8 --num_sample 2 \
